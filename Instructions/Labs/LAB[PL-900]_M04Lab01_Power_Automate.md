...
### Задача #3. Создание шага для отправки сообщения электронной почты посетителю
...
1. Выделите текст {Общий **объем отчета}** . Замените его полем ****"Общий объем** отчета" при добавлении** шага.

1. **Выделите текст {Report Due Date} (Дата выполнения отчета).** Замените его полем **"Дата** выполнения отчета" из **шага "При добавлении** визита".
