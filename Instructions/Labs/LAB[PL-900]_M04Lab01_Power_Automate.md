...
1. Введите "Уведомление о затратах" в поле **Имя потока**.
...
1. В действии **Выбрать строку по идентификатору** нажмите многоточие (**...**) и выберите **Переименовать**. Введите новое имя этого действия "Получить владельца"
...
1. В поле **Тема** введите "Ваш отчет о расходах отправлен"
...
1. Выделите текст **{Общая сумма отчета}**. Замените его значением поля **Общая сумма отчета** с шага **Когда отправляется отчет о расходах**.

1. Выделите текст **{Дата выполнения отчета}**. Замените его значением поля **Дата выполнения отчета** с шага **Когда отправляется отчет о расходах**.
