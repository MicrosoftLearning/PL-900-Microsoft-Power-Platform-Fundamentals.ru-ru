...
## <a name="task-1-create-flow"></a>Задача \#1. Создание потока
...
2.  Щелкните **Создать** и выберите **Автоматизация**, **Облачный поток** и затем **Автоматический**. В новом окне откроется редактор потока Power Automate.

3. В окне **Выбор триггера потока** выполните поиск по запросу **Microsoft Dataverse**.

4. Выберите триггер **При добавлении, изменении или удалении строки**, а затем нажмите кнопку **Создать**.
   ...
   * Для настройки шага триггера нажмите многоточие ( **...** ), затем **Переименовать**. Введите новое имя этого триггера **"При добавлении визита"** . Это позволит вам и другим редакторам потока понять назначение шага без изучения подробностей.

5. Выберите **Новый шаг**. Этот шаг необходим для получения сведений о посетителях, включающих адрес электронной почты.

6. Выполните поиск **Microsoft Dataverse**.
...
9. Выполните поиск слова *почта*, выберите соединитель **Office 365 Outlook** и действие **Отправить по электронной почте (V2)** .
...
14.  Отключите поток, нажав кнопку **Отключить** на панели команд. Возможно, вам потребуется нажать многоточие ( **...** ), чтобы увидеть этот параметр.

15.  Закройте окно.

# <a name="exercise-2-create-security-sweep-flow"></a>Упражнение 2. Создание потока проверки безопасности
...
## <a name="task-1-create-flow-to-retrieve-records"></a>Задача 1. Создание потока извлечения записей
...
2. Щелкните **Создать** и выберите **Автоматизация**, **Облачный поток** и затем **Запланировано**. В новом окне откроется редактор потока Power Automate.

3. Настройте поток для повторения каждые **15** минут.

4. Нажмите кнопку **Создать**.

5. Нажмите кнопку **Новый шаг**. Выполните поиск *Текущий*, затем выберите соединитель **Microsoft Dataverse**. Выберите действие **Список строк**.
...
6.  Нажмите кнопку **Новый шаг**. Найдите раздел *Применить* и выберите действие **Применить к каждому**. 
...
10.  Отправка уведомления по электронной почте

     * Нажмите **Добавить действие** в цикле «Применить к каждому». Добавьте действие **Отправить сообщение электронной почты (V2)** в соединителе **Office 365 Outlook**.
