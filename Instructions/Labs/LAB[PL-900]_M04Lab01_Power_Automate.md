...
1.  Перейдите к <https://make.powerapps.com>. Может потребоваться повторная аутентификация. При необходимости выберите **Вход** и следуйте инструкциям.
...
6.  Введите `Visit Notification` в качестве **имени потока**.
