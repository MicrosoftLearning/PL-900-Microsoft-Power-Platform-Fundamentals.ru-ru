...
1.  Нажмите **Новый шаг**. Это шаг предназначен для отправки посетителю электронного письма.
...
10.  Выделите текст **{Запланированное окончание}** . Поместите сюда поле **Запланированное окончание** из шага **При добавлении визита**.
