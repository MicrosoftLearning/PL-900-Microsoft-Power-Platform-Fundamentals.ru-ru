...
1. В **корректировке** часового пояса выберите **"Только** дата".
    ...
    >**Примечание.** Мы используем **только поведение даты для** записи сведений о дате, так как дата расходов не должна изменяться при просмотре из другого часового пояса.
