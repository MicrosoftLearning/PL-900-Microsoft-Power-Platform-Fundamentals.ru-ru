...
- Описание метаданных (таблицы и связи) можно найти в [документе с описанием модели данных](https://github.com/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals/blob/master/Allfiles/Campus%20Management.png). Чтобы открыть документ модели данных в новом окне, удерживая нажатой клавишу CTRL+ левую кнопку мыши или щелкните ссылку правой кнопкой мыши.
...
## Задача 1. Создание таблицы визитов и столбцов
...
1.  Убедитесь, что в меню **Среда** в правом верхнем углу выбрана среда **для практики** . 

1.  С помощью навигации слева выберите **Таблицы**.

1.  Выберите **+ Создать таблицу** и выберите **Задать дополнительные свойства**. 
...
1.  **Измените значение Обязательное** на **Обязательный для бизнеса**. 

1.  Разверните **Дополнительные параметры**. 

1.  В поле **Корректировка часового пояса** выберите **Независимо от часового пояса**. 

    > **Примечание:** Мы используем поведение **, независимое от часового пояса** , для записи сведений о дате и времени, так как время посещения всегда является локальным по сравнению с расположением здания и не должно меняться при просмотре из другого часового пояса. 
...
1.  Введите в `Actual End` поле **Отображаемое имя**.
...
1.  Выберите **Подстановка** > **Подстановка** в поле **Тип данных**. 

1.  Выберите **Контакт** для **связанной таблицы**. 
...
4.  Нажмите кнопку Waffle в левом верхнем углу, чтобы изменить приложения, и выберите **OneDrive**. (Настройка OneDrive может занять некоторое время. Выберите **Ваш OneDrive готов** , когда вы увидите его на экране.)

5.  Выберите **+ Добавить новый** в меню и выберите **Отправка файлов**.

6.  Найдите и выберите ** файлVisits.xlsx** и нажмите кнопку **Открыть**.

    > **Примечание:** Файл должен находиться в папке**Все файлы** **рабочего стола** >  на виртуальной машине.
...
2.  Убедитесь, что в меню **Среда** в правом верхнем углу выбрана среда **для практики** . 

3.  С помощью навигации слева выберите **Таблицы**. 

4.  Откройте таблицу **Визит** , созданную в предыдущем упражнении. 

5.  В меню в верхней части окна выберите **Импорт** > **данных**.
...
8.  Выберите ** файлVisits.xlsx** , который был загружен в OneDrive в предыдущей задаче. 

9.  Выберите **Далее**. 

10. На экране **Power query** > **Choose data (Выбор данных**) проверка книгу **"Визиты** Excel". 
