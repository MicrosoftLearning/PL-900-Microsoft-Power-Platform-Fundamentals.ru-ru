...
12. Создание столбца подстановки «Посетитель»
    ...
    6.  Введите **visitor_id** в поле **Имя связи**.
    
    7.  Нажмите кнопку **Done**(Готово).

13. Щелкните **Сохранить таблицу** внизу справа.
...
4.  С помощью навигации слева разверните элемент **Dataverse** и выберите «Таблицы».
    >   Они могут отображаться на экране в виде таблиц данных \>. 
...
8.  Найдите и выберите файл **Visits.xls**, скачанный ранее. *(Примечание. Отправка файла может занять одну или две минуты. Не беспокойтесь, если появится сообщение о наличии ошибок сопоставления, мы исправим их позже.)*
...
2.  Обратите внимание, что для таблицы визитов есть много вкладок, в том числе "Столбцы", "Связи", "Бизнес-правила", "Представления" и так далее. 

3.  Для таблицы визитов выберите вкладку **Данные**. Она находится в разделе **Таблицы** \> **Визит**.

3.  Убедитесь, что в таблице есть записи. Вы можете изменить представление, щелкнув имя представления в правом верхнем углу и выбрав новое значение **Все столбцы**. 
