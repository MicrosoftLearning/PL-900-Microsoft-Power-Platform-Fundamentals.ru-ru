...
## <a name="task-1-install-power-bi-desktop--prepare-power-bi-service"></a>Задача \#1. Установка Power BI Desktop и подготовка службы Power BI
...
2. Перейдите по адресу [https://aka.ms/pbidesktopstore](https://aka.ms/pbidesktopstore), чтобы скачать и установить Power BI Desktop.
...
5. Перейдите по адресу [https://app.powerbi.com/](https://app.powerbi.com/) и щелкните **Войти**. 
...
12. Нажмите кнопку **Изменить**. Если пункт меню **Правка** не отображается, нажмите **…** , затем выберите **Правка**.
...
## <a name="task-2-prepare-data"></a>Задача \#2. Подготовка данных

1.  Узнайте URL-адрес своей организации.

    * На новой вкладке перейдите в Центр администрирования Power Platform по адресу <https://admin.powerplatform.com>
...
4. Выберите **Power Platform** слева, затем выберите **Common Data Service (устаревший)** и нажмите **Подключить**. При появлении запроса войдите в систему, используя предоставленные учетные данные, и нажмите кнопку **Подключить**.
...
11. Щелкните **...** рядом **bc_Visit** и выберите **Создать столбец**.
...
16. Сохраните изменения, выбрав **Файл \| Сохранить** и введя имя файла по своему усмотрению.

## <a name="task-3-create-chart-and-time-visualizations"></a>Задача 3. Создание диаграмм и визуализаций с привязкой ко времени
...
10. Протестируйте интерактивность отчета следующим образом.
    ...
    * Щелкните гистограмму. Нажмите стрелку вниз, чтобы включить режим **Детализировать**, затем нажмите столбец для перехода к следующему уровню (месяцам). Другой способ сделать это — щелкнуть **Данные/Детализация \| Развернуть следующий уровень** на ленте.
...
## <a name="task-1-publish-power-bi-report"></a>Задача 1. Публикация отчета в Power BI
...
3. Дождитесь завершения публикации и нажмите **Открыть \<name of your report\>.pbix в Power BI**.

## <a name="task-2-create-power-bi-dashboard"></a>Задача 2. Создание панели мониторинга в Power BI
...
## <a name="task-3-add-visualizations-using-natural-language"></a>Задача 3. Добавление визуализаций с использованием естественного языка
...
## <a name="task-4-build-mobile-phone-view-and-share-a-report-with-a-qr-code"></a>Задача 4. Создание мобильного представления и доступ к отчету с помощью QR-кода

1. На панели мониторинга выберите **Изменить \| Макет для мобильных приложений**.

2. Измените расположение плиток по своему усмотрению.

3. Щелкните **Макет для мобильных приложений** в правом верхнем углу и измените режим просмотра на **Веб-макет**.
