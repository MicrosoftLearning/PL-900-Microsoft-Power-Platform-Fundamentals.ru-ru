...
- Измените представление на **Сегодняшние визиты** с помощью раскрывающегося списка рядом с полем **Активные визиты**. В этом представлении новый визит отображаться не должен, так как он запланирован на завтра.
