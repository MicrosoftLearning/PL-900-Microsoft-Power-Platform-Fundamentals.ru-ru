...
>   **ВАЖНО**. *По умолчанию всем формам задано имя "Сведения". Обязательно проверьте, что выбранная форма имеет тип* **Основные** *, а не какой-то другой.*
...
2.  Создайте новый контакт.
    ...
    1.  Приложение должно открыться в представлении **Мои активные контакты**. Если это не так, нажмите слева на элемент "Визиты". 
