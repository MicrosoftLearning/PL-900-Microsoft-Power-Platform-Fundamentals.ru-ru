...
1.  Когда вам будет предложено указать источник данных в **появившемся поле поиска** , введите **оборудование** и выберите таблицу **"Оборудование** ".
...
1.  В свойстве **Items** введите следующую формулу: `Search([@'Equipment'], EquipSearchInput.Text, 'Equipment Name',Category)`
...
1. **Выберите контейнер SelectedRecord1**, нажмите кнопку **"Вставить**".
