...
6. Выберите **Столбцы таблицы** в левой панели навигации и добавьте под полем **Владелец** следующие поля, перетаскивая столбцы в форму или просто щелкая заголовки столбцов:
...
5. В столбце **Сортировка по...** выберите X, чтобы удалить **Имя**, а затем выберите **Планируемое начало**.
...
9. Нажмите **Сохранить** и дождитесь сохранения изменений.
...
5. На экране добавления страницы выберите **Таблица Dataverse**, а затем нажмите кнопку **Далее**.
...
9. В области навигации выберите **Группа 1** под строкой навигации. Возможно, для этого понадобится развернуть меню слева.

10. В правой части экрана в разделе **Параметры отображения** присвойте свойству **Заголовок** новое значение **Безопасность**.

11. В области навигации в группе безопасности выберите **Подобласть 1**. 

12. Щелкните **многоточие** и в появившемся меню выберите **Удалить подобласть 1**. 

13. Нажмите **Сохранить** и дождитесь сохранения изменений. 

14. После завершения **сохранения** нажмите кнопку **Опубликовать**, чтобы опубликовать изменения. 


### <a name="task-2-test-app"></a>Задача 2. Тестирование приложения
...
2. Создайте новый контакт.
    ...
    1. В верхнем меню щелкните **+ Создать**.
